...
import { addCustomer } from "../service/userservice";
...
const[addDetails, setAddDetails] = React.useState({fullAddress: '', city: '', state:'',  adressType: '', mobileNum: '', fullName: ''  })
    ...
    const onClickingContinue = () => {
        ...
        addCustomer(addDetails).then((res) => {
            console.log(res);
        })
            .catch((error) => {
                console.log(error);
    ...
    return (
        <>
            <Box className="address-box-one">
                <span className="cart-text">Customer Details</span>
            </Box>
            <Box className="address-box-two">
                <Box className="textfield-box-one">
                    <TextField id="outlined-basic" label="Full Name" variant="outlined" size="medium" className="box-one-textfield" onChange={takeName}/>
                    <TextField id="outlined-basic" label="Mobile" variant="outlined" size="medium" className="box-one-textfield" onChange={takeMobNum}/>
                </Box>
                ...
                <Box className="textfield-box-three">
                    ...
                    <TextField id="outlined-basic" label="State" variant="outlined" size="medium" className="box-one-textfield" onChange={takeState} />
                </Box>
            ...
            <Box className="address-box-three">
                {
                    props.orderDisplay ? null :
                        <Button variant="contained" className="place-order-button" onClick={onClickingContinue}>Continue</Button>
                }
            </Box>
        </>
